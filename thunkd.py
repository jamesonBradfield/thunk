...
def _build_initial_messages(task: TaskFile) -> list[dict]:
    ...
    system = (
        ...
        "Use exactly this one Execute_Bash call to stage only your target files and commit: "
        f"`git reset HEAD; git add {' '.join(task.target_files) if task.target_files else '-A'}; "
